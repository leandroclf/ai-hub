...
| Ajuste compensatório administrativo | `PLAYWRIGHT_MODULE=.../playwright-core/index.js R2_COMPOSE_PROJECT=ai_hub_r3qual node hub/deploy/r2/tests/admin-finance-adjustment-smoke.mjs` | PASS; ajuste exigiu razão, bloqueou autoaprovação e foi aprovado por `auditor-global` distinto com recibo persistido |
