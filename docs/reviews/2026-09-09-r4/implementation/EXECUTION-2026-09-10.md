...
| Alertas e runbooks | `bash hub/deploy/r2/tests/observability-alert-proof.sh` | PARCIAL estrutural; regras Prometheus, anchors de runbook, dashboard e montagem Kind passaram; exercício live e recuperação permanecem pendentes |
