...
| `hub/evidence/r2/execution/invalid-provider-output-unit.json` | R2-EXE-04-S02 — resposta incompatível | PASS unitário; normalização rejeita resposta sem campo exigido e não produz sucesso; integração HTTP permanece explicitamente pendente |
