...
| `hub/evidence/r2/execution/admin-sla-freshness-smoke.json` | R2-ADM-10-S02 | PASS integrado local; painel mostrou geração, watermark e atraso real, sem anunciar ausência de violações enquanto a projeção estava atrasada |
