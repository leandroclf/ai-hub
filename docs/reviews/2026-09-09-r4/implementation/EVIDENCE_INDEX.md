...
| `hub/evidence/r2/execution/admin-legacy-contract-smoke.json` | R2-ADM-07-S01; R2-CAT-05-S01 | Parcial integrado; um perfil legado JSON expôs polling/callback e o corpo canônico GET/webhook foi equivalente; segundo contrato legado permanece aberto |
