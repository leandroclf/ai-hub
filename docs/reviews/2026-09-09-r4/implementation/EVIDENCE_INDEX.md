...
| `hub/evidence/r2/execution/browser-smoke.json` | R2-ADM-01-S01/S03, R2-ADM-02-S01/S02, R2-ADM-03-S01, R2-ADM-05-S01, R2-ADM-08-S01 e R2-ADM-10-S01 | PASS integrado local; Chromium validou OIDC/OTP, logout com 401, listagem/editor, erro JSON sem falso sucesso, cliente com readback, composição de produto, consulta de protocolo, leitor global auditado e SLA bilateral |
