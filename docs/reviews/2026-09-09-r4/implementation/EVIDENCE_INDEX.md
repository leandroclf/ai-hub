...
| `hub/evidence/r2/execution/product-optional-partial-postgres.log` | R2-CAT-03-S02 — passo opcional com falha | Parcial integrado; PostgreSQL confirmou etapa obrigatória `SUCCEEDED`, opcional `FAILED` e protocolo `PARTIALLY_SUCCEEDED`; cobrança de marcos elegíveis permanece aberta |
