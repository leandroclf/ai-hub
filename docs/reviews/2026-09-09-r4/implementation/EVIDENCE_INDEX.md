...
| `hub/evidence/r2/execution/admin-service-publication-smoke.json` | R2-CAT-05-S03 | Parcial integrado; v1 publicada rejeitou mutação e preservou hash/revisão; publicação de v2 com migração de schema ainda não foi exercitada |
