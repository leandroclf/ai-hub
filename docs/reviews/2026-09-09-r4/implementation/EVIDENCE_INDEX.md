...
| `hub/evidence/r2/execution/observability-alert-latest.log` | R2-OPE-07-S02 — alertas e runbooks | PARCIAL estrutural; três regras Prometheus resolvem para runbooks existentes, dashboard está presente e o perfil Kind monta `alerts.yml`; disparo live e recuperação ainda pendentes |
...
| 11/09/2026: alertas e runbooks | `bash hub/deploy/r2/tests/observability-alert-proof.sh` | PASS estrutural: alertas, anchors de runbook, dashboard e montagem Kind resolvidos; exercício live permanece pendente |
