...
| `hub/evidence/r2/execution/admin-service-publication-smoke.json` | R2-CAT-05-S03 | Parcial integrado; Chromium criou/publicou v2 com schema incompatível, preservou v1/hash e rejeitou mutação direta; protocolo v1 real durante o upgrade ainda não foi exercitado |
