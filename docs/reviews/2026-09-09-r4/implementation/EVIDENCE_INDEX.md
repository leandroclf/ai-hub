...
| `hub/evidence/r2/execution/snapshot-admission-postgres.log` | R2-CAT-06-S01 | Parcial integrado; PostgreSQL congelou a projeção v1 no protocolo/intenção e não reinterpretou o aceite após alteração local para v2; mutação efetiva no Atlas durante execução permanece aberta |
