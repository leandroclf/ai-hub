...
| `hub/evidence/r2/execution/r2-int-exe-qualification.log` | R2-INT/R2-EXE selecionados; R2-CAT-06-S03 | PASS local nos cenários selecionados; inclui revogação de L1 sem reutilização de segredo e continuidade de binding saudável, enquanto a combinação com snapshot histórico e limites normativos não executados permanece listada no próprio log |
