...
|---|---|---|---|
| B-R4-01 | R3-EXE-01 | `ProviderAdapter` e `rest-json-v1` agora executam contrato REST local independente, com paths declarativos limitados (`submit_path`/`status_path`), API_KEY, SYNC/ASYNC e resposta estrita; fechar adapter/provedor comercial e homologação de jornada completa. | Core e Integrações |
