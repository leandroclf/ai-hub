...
| `offer-resolution-runtime-latest.json` | R2-CAT-02-S01/S02; Atlas resolveu a oferta publicada de `app-acme` para `prov-poll-2` com prioridade, vínculo e hash, recusou `prov-sync-1` fora da oferta com `403/offer_not_eligible` e bloqueou escopo cross-tenant | Fixture local; cenário de SLA inviável e homologação comercial permanecem fora |
