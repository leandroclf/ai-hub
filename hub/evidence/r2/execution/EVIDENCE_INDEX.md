...
| `representation-runtime-latest.json` | R2-EXE-08-S01; Chromium/OIDC executou POST SYNC, GET público e entrega Pulsar/webhook-sink no mesmo ensaio; corpo e SHA-256 foram iguais (`096bd053676587e1b98b74683f91cff44432ebd37eb7bcafeaa3c03dd2517cd0`) | Destino, segredo, PostgreSQL, LocalStack e provider-sim são fixtures locais; timeout v4 foi limitado a 2 s pelo lease de `r4-webhook` |
