...
| `browser-smoke.json` | Chromium real com OIDC PKCE, senha+OTP, editor de contrato REST declarativo, CRUD/readback, navegação, logout, troca segura de usuário, leitor global cross-tenant com finalidade, HTTP 401 pós-logout e 390 px: PASS | Não substitui matriz completa de autorização |
