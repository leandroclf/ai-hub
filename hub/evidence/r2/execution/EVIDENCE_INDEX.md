...
| `product-optional-partial-postgres.log` | R2-CAT-03-S02; teste PostgreSQL/Go race confirmou A obrigatório `SUCCEEDED`, B opcional `FAILED`, representação `PARTIALLY_SUCCEEDED` e estados duráveis na inbox/finalizador | Incidência financeira de somente marcos elegíveis ainda não está integrada a esta prova |
