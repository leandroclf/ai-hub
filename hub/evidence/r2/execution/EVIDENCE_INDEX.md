...
| Artefato | Procedimento e resultado | Limite |
|---|---|---|
| `product-http-latest.log` | `R2_COMPOSE_PROJECT=ai_hub_r3qual node hub/deploy/r2/tests/product-runtime-proof.mjs`: PASS; produto com duas etapas independentes, duas operações/efeitos, GET final `SUCCEEDED` e duplicata sem novo efeito (`r4-product-http-1789109019646`) | Provider-sim local; não homologa provedor comercial ou matriz completa |
