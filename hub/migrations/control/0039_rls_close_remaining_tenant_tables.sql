-- R6-SEG-01: mesma lacuna descrita em migrations/core/0052 — tabelas com
-- tenant_id que nunca entraram na lista de RLS de hub_control.
DO $$ DECLARE t text; BEGIN
  FOREACH t IN ARRAY ARRAY['contracts','credential_bindings','catalog_provisioning_requests','catalog_onboardings','catalog_imports','placements'] LOOP
