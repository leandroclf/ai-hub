# Design: Baseline e evidência integral
## Context
...
### R5-QUA-01 — Baseline reconciliada e resultados com proveniência
Fonte normativa preservada; inventário com chave estável+digest de texto por cenário e manifesto completo do código. Resultados por execução com SHA/diff/image digest/comando/oráculo/status. Mapeamento 16 R4 da edição entregue versus 12 remotos e ponte para os quatro RUN. Fechar fatias herdadas por delta, preservar correções. Não criar novas rodadas como substituto de implementar pendências.
## Technical Decisions
...
|---|---|---|
| R5-QUA-01 | docs/reviews/2026-09-09-r4/implementation/FINAL_REPORT.md, hub/deploy/r2/tests/generate-openspec-results.py, hub/deploy/r2/tests/generate-openspec-inventory.py | Engenharia e Qualidade |
